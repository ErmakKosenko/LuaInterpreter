      ...
      try
        {
          switch (yyn)
            {
  case 2:
#line 23 "binary.yy" // lalr1.cc:847
    { std::cout << "MATCH"; }
#line 469 "binary.tab.cc" // lalr1.cc:847
    break;

  case 3:
#line 24 "binary.yy" // lalr1.cc:847
    { std::cout << "MATCH";}
#line 475 "binary.tab.cc" // lalr1.cc:847
    break;


#line 479 "binary.tab.cc" // lalr1.cc:847
            default:
              break;
            }
        }
  ...
  {
  "\"end of file\"", "error", "$undefined", "ALL", "$accept", "rootNode", YY_NULLPTR
  };
...
#line 748 "binary.tab.cc" // lalr1.cc:1155
