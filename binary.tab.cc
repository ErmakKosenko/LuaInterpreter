      ...
      try
        {
          switch (yyn)
            {
  case 2:
#line 105 "binary.yy" // lalr1.cc:847
    {std::cout << yystack_[0].value.as< std::string > ();	}
#line 613 "binary.tab.cc" // lalr1.cc:847
    break;


#line 617 "binary.tab.cc" // lalr1.cc:847
            default:
              break;
            }
        }
  ...
  "DOTDOTDOT", "Name", "Number", "$accept", "S", YY_NULLPTR
  };
...
#line 894 "binary.tab.cc" // lalr1.cc:1155
